...
struct PLPublicMenuConfiguration {
    ...
    private let otherUserItem = PublicMenuOption(
    ...
    private lazy var informationItem = PublicMenuOption(
        kindOfNode: KindOfPublicMenuNode.none,
    ...
    private lazy var firstItem = PublicMenuElement(
        top: (self.trustedDevice ? otherUserItem : informationItem),
    ...
    private let serviceItem = PublicMenuElement(
    ...
    private let offerItem = PublicMenuElement(
        top: PublicMenuOption(kindOfNode: KindOfPublicMenuNode.none,

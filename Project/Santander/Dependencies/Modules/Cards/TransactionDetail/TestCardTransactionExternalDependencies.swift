//
//  TestCardTransactionExternalDependencies.swift
//  SantanderTests
//
...
struct TestCardTransactionExternalDependencies: CardTransactionDetailExternalDependenciesResolver {
    ...
    let pullOfferConfigRepsitory: MockPullOffersConfigRepository
    
    init(injector: MockDataInjector) {
        self.injector = injector
        self.pullOfferConfigRepsitory =  MockPullOffersConfigRepository(mockDataInjector: injector)

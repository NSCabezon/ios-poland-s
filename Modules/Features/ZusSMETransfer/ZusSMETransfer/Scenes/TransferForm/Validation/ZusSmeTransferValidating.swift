...
protocol ZusSmeTransferValidating {
    func validateForm(
        form: ZusSmeTransferFormViewModel,
        with currentActivefield: TransferFormCurrentActiveField,
        maskAccount: String?
    ) -> InvalidZusSmeTransferFormData
    
    func getAccountRequiredLength() -> Int
}

struct ZusSmeTransferValidator: ZusSmeTransferValidating {
...
private extension ZusSmeTransferValidator {

...
final class PLGetLoginNextSceneUseCase: UseCase<Void, PLGetLoginNextSceneUseCaseOkOutput, PLAuthenticateUseCaseErrorOutput> {
    ...
    public override func executeUseCase(requestValues: Void) throws -> UseCaseResponse<PLGetLoginNextSceneUseCaseOkOutput, PLAuthenticateUseCaseErrorOutput> {

...
protocol ZusTransferConfirmationViewControllerProtocol:
    ErrorPresentable,
    LoaderPresentable,
...
final class ZusTransferConfirmationViewController: UIViewController {
    private let presenter: ZusTransferConfirmationPresenterProtocol
    ...
    init(presenter: ZusTransferConfirmationPresenterProtocol,
...
private extension ZusTransferConfirmationViewController {
...
extension ZusTransferConfirmationViewController: ZusTransferConfirmationViewControllerProtocol {
...
extension ZusTransferConfirmationViewController {
    struct Const {
        struct Color {

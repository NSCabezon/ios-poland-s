...
final class SplitPaymentAccountSelectorPresenter {
...
private extension SplitPaymentAccountSelectorPresenter {
    var coordinator: SplitPaymentAccountSelectorCoordinatorProtocol {
        return dependenciesResolver.resolve(for: SplitPaymentAccountSelectorCoordinatorProtocol.self)
    }
}

extension SplitPaymentAccountSelectorPresenter: AccountSelectorPresenterProtocol {

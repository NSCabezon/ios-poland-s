...
public final class PLNotificationGetUnreadedPushCountUseCase: UseCase<Void, GetUnreadedPushCountUseCaseOkOutput, PLUseCaseErrorOutput<NotificationsErrorType>>, PLNotificationsUseCaseErrorHandlerProtocol {
    ...
    public override func executeUseCase(requestValues: Void) throws -> UseCaseResponse<GetUnreadedPushCountUseCaseOkOutput, PLUseCaseErrorOutput<NotificationsErrorType>> {

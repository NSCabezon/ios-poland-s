//
//  NotificationGetPushDetailsRequest.swift
//  SANPLLibrary
//
...
struct NotificationGetPushDetailsRequest: NetworkProviderRequest {
    let serviceName: String
    let serviceUrl: String
    let method: NetworkProviderMethod
    let headers: [String: String]?
    let queryParams: [String: Any]? = nil
    let jsonBody: NotificationGetPushDetailsParameters?
    let formData: Data?
    ...
    init(serviceName: String,
         ...
         body: Data? = nil,
         jsonBody: NotificationGetPushDetailsParameters? = nil,

//
//  NotificationPushStatusRequest.swift
//  SANPLLibrary
//
...
struct NotificationPushStatusRequest: NetworkProviderRequest {
    let serviceName: String
    let serviceUrl: String
    let method: NetworkProviderMethod
    let headers: [String: String]?
    let queryParams: [String: Any]? = nil
    let jsonBody: PLPushStatusUseCaseInput?
    let formData: Data?
    ...
    init(serviceName: String,
         ...
         body: Data? = nil,
         jsonBody: PLPushStatusUseCaseInput,

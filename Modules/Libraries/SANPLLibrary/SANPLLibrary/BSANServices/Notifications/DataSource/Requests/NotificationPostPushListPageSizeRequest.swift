//
//  NotificationPostPushListPageSizeRequest.swift
//  SANPLLibrary
//
...
struct NotificationPostPushListPageSizeRequest: NetworkProviderRequest {
    let serviceName: String
    let serviceUrl: String
    let method: NetworkProviderMethod
    let headers: [String: String]?
    let queryParams: [String: Any]? = nil
    let jsonBody: NotificationPostPushListPageSizeParameters?
    let formData: Data?
    ...
    init(serviceName: String,
         ...
         body: Data? = nil,
         jsonBody: NotificationPostPushListPageSizeParameters?,

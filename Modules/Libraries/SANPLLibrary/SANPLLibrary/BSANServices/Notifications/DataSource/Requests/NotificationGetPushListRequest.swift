//
//  NotificationGetPushListRequest.swift
//  SANPLLibrary
//
...
struct NotificationGetPushListRequest: NetworkProviderRequest {
    let serviceName: String
    let serviceUrl: String
    let method: NetworkProviderMethod
    let headers: [String: String]?
    let queryParams: [String: Any]? = nil
    let jsonBody: NotificationGetPushListParameters?
    let formData: Data?
    ...
    init(serviceName: String,
         ...
         body: Data? = nil,
         jsonBody: NotificationGetPushListParameters? = nil,

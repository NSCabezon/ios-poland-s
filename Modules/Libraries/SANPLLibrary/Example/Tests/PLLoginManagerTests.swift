...
final class PLLoginManagerTests: Tests {
    ...
    func testAuthenticate() {
        ...
        let parameters = AuthenticateParameters(encryptedPassword: encryptedPassword, userId: "33355343", secondFactorData: SecondFactorDataAuthenticate(response: Response(challenge: Challenge(authorizationType: "SMS_CODE", value: "21794711"), value: "795031")))
